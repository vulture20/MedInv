...
/**
 * Mistral-backed DVD/Blu-ray metadata plugin (GitHub issue #68) — see
 ...
 */
class MistralDvdBlurayProvider implements MetadataProviderInterface
{
    use MistralMetadataProvider;

    /** Identical to ClaudeDvdBlurayProvider::ITEM_FIELDS — see its own docblock. */
