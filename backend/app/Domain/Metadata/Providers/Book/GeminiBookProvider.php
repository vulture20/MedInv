...
/**
 * Gemini-backed book metadata plugin (GitHub issue #66) — see
 ...
 * ClaudeBookProvider's/OpenAiBookProvider's own identical-shaped
 * implementations.
 */
class GeminiBookProvider implements MetadataProviderInterface
{
    use GeminiMetadataProvider;

    /** Same field set as ClaudeBookProvider::ITEM_FIELDS/OpenAiBookProvider::ITEM_FIELDS — see ClaudeBookProvider's own docblock. */
