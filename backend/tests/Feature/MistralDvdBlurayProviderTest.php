...
/**
 * MistralDvdBlurayProvider (GitHub issue #68). The trait's shared
 * request/error handling is already covered by MistralBookProviderTest —
 * this focuses on this provider's own DVD/Blu-ray-specific field mapping.
 */
class MistralDvdBlurayProviderTest extends TestCase
{
    use RefreshDatabase;
    ...
    private function configureApiKey(string $key = 'test-key'): void
    {
        MetadataPlugin::query()->create([
            'provider_key' => 'dvd_bluray.mistral',
            'name' => 'Mistral',
    ...
    public function test_lookup_by_code_maps_a_found_item(): void
    {
        ...
        $candidate = app(MistralDvdBlurayProvider::class)->lookupByCode('7321900219658')[0];
    ...
    public function test_lookup_by_code_returns_no_candidates_when_not_found(): void
    {
        ...
        $this->assertSame([], app(MistralDvdBlurayProvider::class)->lookupByCode('0000000000000'));
    }
    ...
    public function test_lookup_by_code_throws_when_the_request_fails(): void
    {
        ...
        app(MistralDvdBlurayProvider::class)->lookupByCode('7321900219658');
    }
    ...
    public function test_search_maps_items_without_a_known_ean(): void
    {
        ...
        $candidates = app(MistralDvdBlurayProvider::class)->search('matrix reloaded');
    ...
    {
        $provider = app(MistralDvdBlurayProvider::class);
